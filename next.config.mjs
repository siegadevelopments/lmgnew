  ...
  headers: async () => [
    {
      ...
      headers: [
        ...
        { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=(), interest-cohort=()' },
        {
          ...
          value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.supabase.co https://*.vercel-scripts.com https://va.vercel-scripts.com https://vercel.live https://*.vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https://*.supabase.co https://*.wixstatic.com https://*.lifestylemedicinegateway.com https://img.youtube.com https://www.lifestylemedicinegateway.com https://vercel.live https://*.vercel.live; connect-src 'self' https://*.supabase.co https://*.mux.com https://vitals.vercel-insights.com https://vercel.live https://*.vercel.live; frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://*.mux.com https://vercel.live https://*.vercel.live; media-src 'self' blob: https://*.supabase.co https://stream.mux.com; object-src 'none'; base-uri 'self';"
        }
      ],
    },
    {

...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Terms of Service for Lifestyle Medicine Gateway and e-training group." },
    ],
  }),
  component: TermsPage,
});
    ...
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none text-foreground prose-headings:text-foreground prose-strong:text-foreground prose-a:text-primary">
          ...
          <p>
            This website is operated by <strong>E-training group</strong>. Throughout the site, the terms “we”, “us” and “our” refer to E-training group. E-training group offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
          </p>
          ...
          <p>
            Our store is created by <strong>Apprising Creatives</strong>. They provide us with the online e-commerce platform that allows us to sell our products and Services to you.
          </p>
          ...
          <section className="mt-12">
            <h2 className="text-2xl font-bold mb-6">SECTION 3 - ACCURACY AND TIMELINESS OF INFORMATION</h2>
            <p>
          ...
          <section className="mt-12">
            <h2 className="text-2xl font-bold mb-6">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
            <p>
          ...
          <section className="mt-12">
            ...
            <p>
              Certain products or Services may be available exclusively online through the website. These products or Services may have limited quantities and are subject to return or exchange only according to our <Link to="/refund-policy" className="underline">Return Policy</Link>.
            </p>
            <p>
          ...
          <section className="mt-12">
            <h2 className="text-2xl font-bold mb-6">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
            <p>
          ...
          <section className="mt-12">
            ...
            <p>
              If you send creative ideas, suggestions, or other materials, you agree that we may, at any time, without restriction, edit, copy, publish, distribute, and otherwise use in any medium any comments that you forward to us.
            </p>
          </section>
          ...
          <section className="mt-12">
            ...
            <p>
              Your submission of personal information through the store is governed by our <Link to="/privacy" className="underline">Privacy Policy</Link>.
            </p>
          </section>
          ...
          <section className="mt-12">
            ...
            <p>
              You are prohibited from using the site or its content: (a) for any unlawful purpose; (b) to solicit others to perform or participate in any unlawful acts; (c) to violate any regulations, rules, or laws; (d) to infringe upon or violate our intellectual property rights; (e) to harass, abuse, or discriminate; (f) to submit false or misleading information; (g) to upload viruses or malicious code.
            </p>
          </section>
          ...
          <section className="mt-12 text-muted-foreground border-t pt-10">
            ...
            <p>
              These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of <strong>Australia</strong>.
            </p>
          </section>
          ...
          <section className="mt-12">
            ...
            <p>
              Questions about the Terms of Service should be sent to us at <strong>info@lifestylemedicinegateway.com</strong>.
            </p>
          </section>
        </div>
      </main>

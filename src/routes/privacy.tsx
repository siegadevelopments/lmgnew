...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Privacy Policy for Lifestyle Medicine Gateway and e-training group." },
    ],
  }),
    ...
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none text-foreground prose-headings:text-foreground prose-strong:text-foreground prose-a:text-primary">
          <p>
            This Privacy Policy describes how <strong>e-training group</strong> (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from <strong>lifestylemedicinegateway.com</strong> (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
          </p>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">How We Collect and Use Your Personal Information</h2>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Shopping information including the items you view, put in your cart or add to your wish list.</li>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">Security and Retention of Your Information</h2>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Right to Limit and/or Opt out of Use and Disclosure of Sensitive Personal Information.</li>
            <li>Restriction of Processing.</li>
            <li>Withdrawal of Consent.</li>
          </ul>

          <h2 className="text-2xl font-bold mt-10 mb-4">Contact</h2>
          <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at <strong>info@lifestylemedicinegateway.com</strong> or contact us at:</p>
          <p className="font-bold">
            102 Rymer Ave SAFETY BEACH, Melbourne, VIC, 3936, Australia.
          </p>
        </div>
      </main>
    </div>

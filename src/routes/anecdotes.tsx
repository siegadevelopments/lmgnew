...
export const Route = createFileRoute("/anecdotes")({
  loader: ({ context: { queryClient } }) => {
    return queryClient.ensureQueryData(articlesQueryOptions());
  },
  head: () => ({
    meta: [
      { title: "Wellness Anecdotes & Wisdom | Lifestyle Medicine Gateway" },
      {
        name: "description",
        content: "A collection of wisdom, tips, and anecdotes from our wellness community.",
      },
    ],
  }),
  component: AnecdotesPage,
});

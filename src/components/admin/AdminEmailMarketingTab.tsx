...
const CAMPAIGN_TEMPLATES: CampaignTemplate[] = [
  {
    ...
    type: "welcome",
    aiPrompt:
      "Write a warm, welcoming email for a new subscriber to Lifestyle Medicine Gateway. Focus on health, wellness, and the benefits of our products. Include a placeholder for a 15% discount code.",
  },
  {
    id: "promo",
    ...
    description:
      "High-conversion promotional email focused on urgency and digital marketing best practices.",
    type: "promo",
    aiPrompt:
      "Write a high-energy promotional email for a flash sale. Use persuasive copywriting techniques, create urgency, and highlight the value of investing in one's health.",
  },
  {
    id: "educational",
    ...
    type: "educational",
    aiPrompt:
      "Create a newsletter-style email that introduces a complex wellness topic in an easy-to-digest way. Link to recent articles and offer genuine value before asking for a sale.",
  },
  {
    id: "winback",
    ...
    description:
      "Win back inactive subscribers with a personalized message and a strong incentive.",
    type: "re-engagement",
    aiPrompt:
      "Write a soft, caring email for subscribers who haven't opened emails in a while. Ask for feedback on how we can improve and offer a 'welcome back' gift.",
  },
  {
    id: "sales-funnel",
    ...
    description:
      "A psychological 4-part sequence: Education -> Social Proof -> Value -> Scarcity. Designed for 40%+ conversion.",
    type: "promo",
    aiPrompt:
      "Generate a 4-part email sequence for a new wellness customer. Email 1: The 'Why' & Founders Story. Email 2: Common health myths vs facts. Email 3: Customer success stories and 'Before/After' results. Email 4: A limited 48-hour offer with strong urgency.",
  },
];
    ...
    <div className="space-y-6 pb-20">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Automate your conversion funnel with AI-powered campaigns.
        </p>
      </div>
          ...
          <Card className="border-dashed border-2 border-border/50 bg-transparent">
            <CardContent className="p-4 flex flex-col items-center justify-center py-8 text-center opacity-60">
              ...
              <p className="text-[10px] text-muted-foreground">
                Pro Feature: Segment based on purchase history
              </p>
            </CardContent>
          </Card>
        </div>
            ...
            <div className="bg-gradient-to-r from-primary/5 to-purple-500/5 border-b border-border/50 p-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    {selectedTemplate
                      ? "Configure and review your AI-generated campaign."
                      : "Choose a best-practice template to start."}
                  </CardDescription>
                </div>
              </div>
              {selectedTemplate && (
                <Badge
                  variant="secondary"
                  className="gap-1 animate-pulse bg-primary/20 text-primary border-primary/20"
                >
              ...
              {!selectedTemplate ? (
                <div className="py-20 text-center space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                    Select one of our conversion-optimized templates on the left. Our AI will help
                    you craft the perfect message for your subscribers.
                  </p>
                </div>
              ) : (
                <>
                    ...
                    {isGenerating ? (
                      <div className="h-[300px] w-full rounded-md bg-muted/30 border border-border/50 flex flex-col items-center justify-center gap-4">
                        ...
                        <p className="text-sm font-medium animate-pulse">
                          Applying digital marketing best practices...
                        </p>
                      </div>
                    ) : (
                      <Textarea
                  ...
                  <div className="pt-4 flex flex-col sm:flex-row items-center gap-3">
                    ...
                    <p className="text-[10px] text-muted-foreground sm:ml-auto text-center sm:text-right">
                      ...
                      <span className="font-bold">Urgency</span> and{" "}
                      <span className="font-bold">Social Proof</span> <br />

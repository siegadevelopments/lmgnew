            ...
            <form onSubmit={handleSave} className="grid gap-4">
              ...
              <div className="flex gap-2 pt-2">
                <Button type="submit" disabled={submitting}>
                  {submitting ? "Saving..." : form.id ? "Update Article" : "Publish Article"}
                </Button>
              ...
              <div className="flex items-center gap-4 min-w-0 flex-1">
                <div className="h-12 w-12 rounded-lg overflow-hidden bg-muted flex-shrink-0 border border-border/50">
                  {a.image_url ? (
                    ...
                    <div className="h-full w-full flex items-center justify-center text-muted-foreground/30 font-bold text-xs">
                      IMG
                    </div>
                  )}
                </div>

          ...
          <CardContent className="h-[300px] flex flex-col">
            ...
            <div className="mt-4 grid grid-cols-1 gap-2">
              {contentDist.map((entry, index) => (
                <div
                  key={entry.name}
                  className="flex items-center justify-between text-xs px-3 py-2 rounded-lg bg-muted/30"
                >
      ...
      <Card className="border-border/50 bg-primary/5 border-primary/10">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Your store is currently <strong className="text-foreground">Active</strong>. In the last
            7 days, you've generated{" "}
            ...
            {articleCount < 5 && (
              <>
                ...
                <strong className="text-foreground">2 articles</strong> per week to boost your SEO
            ...
            {orderCount > 0 && (
              <>
                ...
                <strong className="text-foreground">${(totalSales / orderCount).toFixed(2)}</strong>
                .
              </>
            )}
          </p>

export const metadata = {
  ...
  description: "Review our return and refund policy for e-training group and lifestylemedicinegateway.com.",
};
        ...
        <div className="prose prose-slate max-w-none text-foreground prose-headings:text-foreground prose-strong:text-foreground prose-a:text-primary space-y-10">
          <section>
            ...
            <p>
              ...
              <strong>orders@lifestylemedicinegateway.com</strong>. Please note that returns will
              need to be sent back to the distributing business or company.
            </p>
            <p>
              If your return is accepted, the distributing business will contact you with
              instructions on how and where to send your package. Items sent back without first
              requesting a return will not be accepted. Please note that if your country of
              residence is not Australia, shipping your goods may take longer than expected and at
              your cost if specified by the distributing business.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              The fastest way to ensure you get what you want is to return the item you have once
              you have contacted us, and once the return is accepted, make a separate purchase for
              the new item.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Notwithstanding the above, if merchandise is being shipped into the European Union,
              you have the right to cancel or return your order within 3 days for any reason and
              without justification. As above, your item must be in the same condition that you
              received it, unworn or unused, with tags, and in its original packaging. You’ll also
          ...
          <section>
            ...
            <p>
              We will notify you once the distributing business has received and inspected your
              return to let you know if the refund was approved or not. If approved, you’ll be
              automatically refunded on your original payment method within{" "}
              <strong>10 business days</strong>. Please remember it can take some time for your bank
            ...
            <p>
              ...
              contact us at <strong>info@lifestylemedicinegateway.com</strong>.
            </p>
          </section>
        </div>
      </main>

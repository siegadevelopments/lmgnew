...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/studies`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
    { url: `${SITE_URL}/anecdotes`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.6 },
    { url: `${SITE_URL}/memes`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.5 },
    ...
    { url: `${SITE_URL}/affiliates`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.4 },

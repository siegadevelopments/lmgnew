...
function VendorDashboardContent() {
  ...
  }, [orderIdParam, activeTabParam, activeTab]);
            ...
            <CardContent className="px-8 pb-10">
              <form onSubmit={handleCreateStore} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input id="store_name" name="store_name" placeholder="e.g. Pure Wellness Co." className="h-12 text-lg shadow-inner bg-background/50" required />
                </div>
                <div className="space-y-2">
                ...
                <p className="text-center text-[10px] text-muted-foreground uppercase tracking-widest font-bold opacity-50">By proceeding, you agree to our Vendor Terms & Conditions</p>
              </form>
            </CardContent>
          </Card>
        </motion.div>
            ...
            <TabsContent value="products" className="mt-0 border-0 p-0">
              <div className="mb-6 flex flex-col gap-1">
                <h1 className="text-2xl font-bold tracking-tight">
                  {profile.vendor_type === "both" ? "Products & Services" : profile.vendor_type === "services" ? "Service Offerings" : "Product Catalog"}
                </h1>
                <p className="text-muted-foreground">Add and manage the items you sell.</p>
              </div>
...
export default function VendorDashboardPage() {
  return (
    <Suspense fallback={<div className="flex h-[60vh] items-center justify-center"><div className="h-8 w-8 animate-spin rounded-full border-4 border-primary border-t-transparent" /></div>}>
